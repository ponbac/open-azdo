...
import type { ReviewCliInput } from "../config/AppConfig"
import { runReviewWorkflow } from "../review/Workflow"
import { BaseRuntimeLayer, makeRuntimeLayer } from "./Runtime"

const PositiveIntSchema = Schema.Int.check(Schema.isGreaterThan(0))

export const executeReviewWithInput = (input: ReviewCliInput) =>
  runReviewWorkflow.pipe(Effect.provide(makeRuntimeLayer(input)))
